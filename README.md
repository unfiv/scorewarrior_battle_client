...
## Итог:
- Не все механики реализованы корректно.
- Не идеально разделены Core/Features, есть связность.
- Решение расширяемо, но чувствительно к контролю порядка.
- Стоило попробовать POC для решения с Очередью Событий.

## Альтернатива с Очередью Событий:
- Отделяем принятие решений по изменению от фактического изменения состояния Мира.
- Видна вся картина, легко выполняем любые логические операции над цепочками.